...
* The original package name 'edu.miu.projectmanagement.registration-srv' is invalid and this project uses 'edu.miu.projectmanagement.registrationsrv' instead.
